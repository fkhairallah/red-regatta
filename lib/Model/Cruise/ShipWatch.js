...
const formatISO_1 = (0, tslib_1.__importDefault)(require("date-fns/formatISO"));
...
class ShipWatch {
    constructor(srcObject) {
        ...
        this.startDate = (0, formatISO_1.default)(new Date(), { representation: "date" });
        ;
        this.hoursInWatch = 2;
    ...
    getDateSchedule(myDate, lengthInDays = 1) {
        let watchCrew = [];
        let numberOfDays = (0, differenceInDays_1.default)(myDate, new Date(this.startDate));
